...
class Proof_Factor_Public
{
    ...
    public function enqueue_scripts()
    {
        ...
        if (empty($proof_account_id) == false) {
            wp_enqueue_script("{$this->plugin_name}-widget-code", "https://api.prooffactor.com/v1/partners/woo_commerce/jsembed.js?account_id={$proof_account_id}&site_url={$blog_url}", array(), $this->version, false);
        }
    ...
    public function embed_proof()
    {
        ...
        if (empty($proof_account_id)) { return; }
        ...
        if (empty($html)) {
            ...
            $response = wp_remote_get("https://api.prooffactor.com/v1/partners/woo_commerce/embed?account_id={$proof_account_id}&site_url={$blog_url}");
