...
class Proof_Factor_Admin
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/proof-factor-admin.css', array(), $this->version, 'all');
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/proof-factor-admin.js', array('jquery'), $this->version, false);
    ...
    public function admin_notice_html()
    {
        ...
        if (stripos($actual_link, 'page=proof-factor') == false && empty($proof_account_id) && empty($proof_user_id)) {
            ?>
            <div class="notice notice-error is-dismissible">
                <p class="ps-error">Proof Factor is not configured! <a href="admin.php?page=proof-factor">Click here</a>
                </p>
            </div>
            <?php
        }
    ...
    {
        include_once('partials/proof-factor-admin-display.php');
    }
    ...
    function added_options($option_name, $new_value) {
        ...
        Proof_Factor_Helper::remote_json_post("https://api.prooffactor.com/v1/partners/woo_commerce/updated_settings", $payload);
    }
